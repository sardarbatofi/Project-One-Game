<template>
  ...
  <div class="grid-container">
    ...
    <div class="difficulty" v-show="!game">
      ...
      <button class="button" v-on:click="game = !game" @click="tries=15, diffTime=40, easy=!easy" >Easy</button>
      <button class="button" v-on:click="game = !game" @click="tries=10, diffTime=30, medium=!medium">Medium</button>
      <button class="button" v-on:click="game = !game" @click="tries=5, diffTime=15, hard=!hard">Hard</button>
    </div>
